...
ToneAndPreviewControls.propTypes = {
    tone: PropTypes.string.isRequired,
    setTone: PropTypes.func.isRequired,
    previewContent: PropTypes.string.isRequired,
    applyPreviewToMain: PropTypes.func.isRequired,
};

export default ToneAndPreviewControls;
